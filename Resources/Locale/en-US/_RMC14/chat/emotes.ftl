...
rmc-hands-emotes-dapup-self = You dap up {$target}!
rmc-hands-emotes-dapup = {$ent} daps up {$target}!

rmc-hands-emotes-dapup-attempt-self = You extend your hand out for a dap up from {$target}.
rmc-hands-emotes-dapup-attempt = {$ent} extends {POSS-ADJ($ent)} hand out for a dap up from {$target}.
