...
server-currency-name-singular = Clown Coin
server-currency-name-plural = Clown Coins
...
gs-balanceui-shop-buy-token-antag = Buy an Antag Token - {$price} Clown Coins
gs-balanceui-shop-buy-token-admin-abuse = Buy an Admin Abuse Token - {$price} Clown Coins
gs-balanceui-shop-buy-token-hat = Buy a Hat Token - {$price} Clown Coins
