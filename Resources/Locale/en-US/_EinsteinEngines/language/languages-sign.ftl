chat-sign-language-message-wrap = [italic][BubbleHeader]{$languageIcon}[Name]{$entityName}[/Name][/BubbleHeader] [BubbleContent]{$verb} "[font="{$fontType}" size={$fontSize}][color={$color}]{$message}[/color][/font]"[/italic][/BubbleContent]{$language}
chat-sign-language-whisper-wrap = [italic][BubbleHeader]{$languageIcon}[Name]{$entityName}[/Name][/BubbleHeader] [BubbleContent]subtly gestures "[font="{$fontType}" size={$fontSize}][color={$color}]{$message}[/color][/font]"[/italic][/BubbleContent]{$language}
...
# Tajaran stuffs
chat-sign-tajaran-language-message-wrap = [italic][BubbleHeader]{$languageIcon}[Name]{$entityName}[/Name][/BubbleHeader] [BubbleContent]{$verb} "[font="{$fontType}" size={$fontSize}][color={$color}]{$message}[/color][/font]"[/italic][/BubbleContent]{$language}
chat-sign-tajaran-language-whisper-wrap = [italic][BubbleHeader]{$languageIcon}[Name]{$entityName}[/Name][/BubbleHeader] [BubbleContent]subtly {$verb} "[font="{$fontType}" size={$fontSize}][color={$color}]{$message}[/color][/font]"[/italic][/BubbleContent]{$language}
