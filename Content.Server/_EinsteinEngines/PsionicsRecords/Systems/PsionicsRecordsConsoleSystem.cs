...
using Content.Shared._EinsteinEngines.PsionicsRecords;
using Content.Shared._EinsteinEngines.PsionicsRecords.Components;
using Content.Shared._EinsteinEngines.PsionicsRecords.Systems;
...
namespace Content.Server._EinsteinEngines.PsionicsRecords.Systems;
